...
namespace PPE_Salons
{
    public partial class PageParticipant : Form
    {
        ...
        private void Enregistrer_Click(object sender, EventArgs e)
        {
            ...
            {
                LeParticipant.Save();
                Valid.Text = "Enregistrement effectué";
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            StreamWriter monStreamWriter = new StreamWriter(@"C:\wamp64\wamp64(2)\www\QCM\qrcode.html");//Necessite using System.IO;
            ...
            System.Diagnostics.Process.Start("FireFox", @"C:\wamp64\wamp64(2)\www\QCM\qrcode.html");
